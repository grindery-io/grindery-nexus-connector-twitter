...
import { TriggerBase, ConnectorDefinition } from "grindery-nexus-common-utils";
...
class NewFollowerTrigger extends TriggerBase<NewFollowerTriggerFields, unknown, NewFollowerTriggerInitStates> {
  async main() {
...
export const CONNECTOR_DEFINITION: ConnectorDefinition = {
  actions: {},
  triggers: { newFollowerTrigger: NewFollowerTrigger },
  webhooks: {},
};
